    ...
    fun logIn(username: String, password: String, callback: OperationCallback) {
        ...
        val jsonObjectRequest = JsonObjectRequest(Request.Method.POST, url, jsonObject,
            ...
            Response.ErrorListener { error ->
                Log.d("CONSOLE_49", "message ${error.message}")
                //Log.d("CONSOLE_50","responseError ${error.networkResponse.statusCode}")
                ...
                val messageError =
                    "error : ${error.message} code : ${error.networkResponse.statusCode}"
